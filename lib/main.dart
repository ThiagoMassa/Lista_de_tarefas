...
const COR_PRIMARIA1 = Colors.teal;
const COR_PRIMARIA2 = Colors.cyan;
...
void main() {
  runApp(MaterialApp(
    ...
    theme: ThemeData(
        hintColor: COR_PRIMARIA1,
        primaryColor: COR_PRIMARIA1,
        cursorColor: COR_PRIMARIA1,
        inputDecorationTheme: InputDecorationTheme(
          hintStyle: TextStyle(color: COR_PRIMARIA2),
        )),
  ));
}
...
class _HomeState extends State<Home> {
    ...
    return Scaffold(
            ...
            children: <Widget>[
              Expanded(
                ...
                decoration: InputDecoration(
                    ...
                    labelStyle: TextStyle(color: COR_PRIMARIA1, fontSize: 20)),
      ...
      bottomNavigationBar: Container(
        ...
        child: Row(
          ...
          children: <Widget>[
            Text(
              "Powered by github.com/ThiagoMassa",
            )
          ],
        ),
      ),
    ...
    return Dismissible(
      ...
      child: CheckboxListTile(
        ...
        secondary: CircleAvatar(
          ...
          backgroundColor: COR_PRIMARIA2,
          foregroundColor: Colors.white,
        ),
        activeColor: COR_PRIMARIA2,
        onChanged: (value) {
          setState(() {
            obj["done"] = value;
          });
  ...
  Widget buildBarButton(Icon icon, Function function) {
    return ButtonTheme(
      minWidth: 40.0,
      child: FlatButton(child: icon, onPressed: _doneAll),
    );
  }
  ...
  void _doneAll() {
    ...
    _showMyDialog(
        "Conclução de Tarefas", "Deseja concluir todas as tarefas?", callback);
  }
